...
const AVATAR_ART = {
  ...
  blueWater: '<svg viewBox="0 0 48 48"><g class="aa-boatHeel"><path d="M26 4 V33" /><path fill="currentColor" stroke="none" d="M24.5 7 L24.5 32 L10 32 C13 22 18.5 13 24.5 7 Z"/><path fill="currentColor" stroke="none" d="M27.5 12 L27.5 31 L38.5 31 C36 23.5 32 17 27.5 12 Z"/><path fill="currentColor" stroke="none" d="M6 34.5 H42 L36 42.5 C34.5 43.8 33 44 31 44 L17 44 C15 44 13.5 43.8 12 42.5 Z"/></g><path d="M3 46 Q9 43.5 15 46 M18 46.5 Q24 44 30 46.5 M33 46 Q39 43.5 45 46" opacity=".45"/></svg>',
